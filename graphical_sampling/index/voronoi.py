...
class Voronoi:
    ...
    def score(self, samples: np.ndarray) -> np.ndarray:
        ...
        with localconverter(default_converter + numpy2ri.converter):
            ...
            ro.r("""
                    score_voronoi <- function(W, inclusions, coords, samples_list) {
                      ...
                      for (i in seq_len(S)) {
                        ...
                        SBs[i] <- tryCatch(sb(inclusions, coords, samp_idx), error = function(e) Inf)
            ...
            # Call it once
            result = ro.r("score_voronoi(W, inclusions, coords, samples)")
